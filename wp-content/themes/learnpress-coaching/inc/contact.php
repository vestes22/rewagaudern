...
class Learnpress_Coaching_Contact_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Learnpress_Coaching_Contact_Widget', 
			__('Contact Us', 'learnpress-coaching'),
			array( 'description' => __( 'Widget for Contact Us section', 'learnpress-coaching' ), ) 
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		<div class="widget">
	        ...
	        <?php if(!empty($phone) ){ ?><p class="my-3 mx-0"><span class="custom_details"><?php esc_html_e('Phone No: ','learnpress-coaching'); ?></span><span class="custom_desc"><?php echo esc_html($instance['phone']); ?></span></p><?php } ?>
	        <?php if(!empty($email) ){ ?><p class="my-3 mx-0"><span class="custom_details"><?php esc_html_e('Email ID: ','learnpress-coaching'); ?></span><span class="custom_desc"><?php echo esc_html($instance['email']); ?></span></p><?php } ?>
	        <?php if(!empty($address) ){ ?><p class="my-3 mx-0"><span class="custom_details"><?php esc_html_e('Address: ','learnpress-coaching'); ?></span><span class="custom_desc"><?php echo esc_html($instance['address']); ?></span></p><?php } ?> 
	        <?php if(!empty($timing) ){ ?><p class="my-3 mx-0"><span class="custom_details"><?php esc_html_e('Opening Time: ','learnpress-coaching'); ?></span><span class="custom_desc"><?php echo esc_html($instance['timing']); ?></span></p><?php } ?>
	...
	public function form( $instance ) {
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('heading')); ?>"><?php esc_html_e('Heading:','learnpress-coaching'); ?></label>
    	...
    	<p>
        	<label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Phone Number:','learnpress-coaching'); ?></label>
        	<input class="widefat" id="<?php echo esc_attr($this->get_field_id('phone')); ?>" name="<?php echo esc_attr($this->get_field_name('phone')); ?>" type="text" value="<?php echo esc_attr($phone); ?>">
    	</p>
    	<p>
        	<label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email id:','learnpress-coaching'); ?></label>
        	<input class="widefat" id="<?php echo esc_attr($this->get_field_id('email')); ?>" name="<?php echo esc_attr($this->get_field_name('email')); ?>" type="text" value="<?php echo esc_attr($email); ?>">
    	</p>
    	<p>
        	<label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Address:','learnpress-coaching'); ?></label>
        	<input class="widefat" id="<?php echo esc_attr($this->get_field_id('address')); ?>" name="<?php echo esc_attr($this->get_field_name('address')); ?>" type="text" value="<?php echo esc_attr($address); ?>">
    	</p>
    	<p>
        	<label for="<?php echo esc_attr($this->get_field_id('timing')); ?>"><?php esc_html_e('Opening Time:','learnpress-coaching'); ?></label>
    	...
    	<p>
        	<label for="<?php echo esc_attr($this->get_field_id('longitude')); ?>"><?php esc_html_e('Longitude:','learnpress-coaching'); ?></label>
    	...
    	<p>
        	<label for="<?php echo esc_attr($this->get_field_id('latitude')); ?>"><?php esc_html_e('Latitude:','learnpress-coaching'); ?></label>
    	...
    	<p>
        	<label for="<?php echo esc_attr($this->get_field_id('contact_form')); ?>"><?php esc_html_e('Contact Form Shortcode:','learnpress-coaching'); ?></label>
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['phone'] = (!empty($new_instance['phone']) ) ? learnpress_coaching_sanitize_phone_number($new_instance['phone']) : '';
...
function learnpress_coaching_contact_custom_load_widget() {
	register_widget( 'Learnpress_Coaching_Contact_Widget' );
}
add_action( 'widgets_init', 'learnpress_coaching_contact_custom_load_widget' );