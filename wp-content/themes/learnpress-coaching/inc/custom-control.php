...
class Learnpress_Coaching_Custom_Control extends WP_Customize_Control {
...
class Learnpress_Coaching_Image_Radio_Control extends WP_Customize_Control {
    public function render_content() {
        ...
        <ul class="controls" id='learnpress-coaching-img-container'>
            <?php
            foreach ($this->choices as $value => $label) :
                $class = ($this->value() == $value) ? 'learnpress-coaching-radio-img-selected learnpress-coaching-radio-img-img' : 'learnpress-coaching-radio-img-img';
                ?>
